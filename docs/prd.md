# HX Treasure Grab Brownfield Enhancement PRD
...
HX Treasure Grab is a browser-based treasure hunting game built with vanilla HTML, CSS, and JavaScript. It's a single-page application with all game logic contained in `index.html` (~4,320 lines of code).
